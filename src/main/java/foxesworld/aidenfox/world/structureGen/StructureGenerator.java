...
public class StructureGenerator {
    ...
    public StructureGenerator(String filename, String MODID){
    ...
    public StructureGenerator(String structureName, int biomeToGen, int rarity, Block blockToGenOn, StructureInstance structureInstance) {

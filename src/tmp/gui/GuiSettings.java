...
public class GuiSettings extends GuiContainer{
    ...
    final private ResourceLocation texture = new ResourceLocation(Environment.MODID, "textures/gui/Black.png");
    ...
    public void initGui(){
        buttonList.clear();
        buttonList.add(new GuiButton(1, (this.width - xSize) / 2 + 5, this.height / 2 - 80, 170, 20, I18n.format(I18n.format("customdebug.coords") + ": " + on(ConfigCreator.debug))));
    ...
    protected void actionPerformed(GuiButton button){
        switch (button.id){
            case 1:{
                ConfigCreator.debug = swap(ConfigCreator.debug);
                this.initGui();
